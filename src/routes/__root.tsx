...
function RootComponent() { const { queryClient } = Route.useRouteContext(); return <QueryClientProvider client={queryClient}><a href="#main-content" className="fixed left-4 top-3 z-50 -translate-y-20 bg-primary px-4 py-2 text-primary-foreground focus:translate-y-0">Skip to content</a><SiteHeader /><main id="main-content"><Outlet /></main><SiteFooter /><Toaster position="bottom-right" /></QueryClientProvider>; }
