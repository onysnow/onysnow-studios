...
export const Route = createFileRoute("/book")({
  ...
  loader: ({ context: { queryClient } }) =>
    Promise.all([
      ...
      queryClient.ensureQueryData(pageCopyQuery("book")),
    ]),
  head: () => ({
    meta: [
      { title: "Book a Session — OnySnow Studios" },
      {
        name: "description",
        content: "Start planning your photography session with OnySnow Studios.",
      },
      { property: "og:title", content: "Book a Session — OnySnow Studios" },
      {
        property: "og:description",
        content: "Tell us what you are imagining and start planning your shoot.",
      },
...
function Book() {
  ...
  return (
    <>
      <PageIntro
        loading={isPending}
        eyebrow={copy(text, "intro_eyebrow", "Book a session")}
        title={copy(text, "intro_title", "Let’s begin with your story.")}
