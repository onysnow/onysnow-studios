  ...
  return <>
    <section className="relative min-h-[92svh] overflow-hidden">
      ...
      <div className="relative mx-auto flex min-h-[92svh] max-w-screen-2xl flex-col justify-end px-5 pb-14 sm:px-8 lg:px-12 lg:pb-20">
        ...
        <h1 className="mt-4 max-w-4xl font-display text-[2.75rem] leading-[.95] sm:text-6xl lg:text-[4.5rem]"><ScrambleText text={copy(text, "hero_title", "Life, exactly as it felt.")} /></h1>
