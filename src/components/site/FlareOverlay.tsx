...
const CHROMA: Flare = { name: "chroma", anchor: { x: 0.78, y: 0.2 }, scale: 0.85, opacity: 0.38 };

/** Unused for now, kept so swapping which flare plays is a one-line change. */
void STREAK_GREEN;
void BEAM;

const ACTIVE: Flare[] = [STREAK_BLUE, CHROMA];
